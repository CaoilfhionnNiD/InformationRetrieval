...
public class QueryIndex
{
	...
	private static Path currentRelativePath = Paths.get("").toAbsolutePath();

	private static String TOPICS_DIRECTORY = String.format("%s/Files/topics", currentRelativePath);
	...
	{
		String GLOVE_DIRECTORY = String.format("%s/src/com/kerinb/Lucenefer/glove.6B.50d.txt", currentRelativePath);
		wordEmbeddingModel = new WordEmbeddingModel(GLOVE_DIRECTORY);
