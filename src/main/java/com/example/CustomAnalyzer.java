...
public class CustomAnalyzer extends Analyzer {
    ...
    protected TokenStreamComponents createComponents(String s) {
        ...
        // Adjust the order and configuration of the FlattenGraphFilter and
        // SynonymGraphFilter
        // stream = new FlattenGraphFilter(new SynonymGraphFilter(stream,
        // wordExpansion(), true));
        /*
         * stream = new NGramTokenFilter(stream, 2, 3, true);
         * 
         * stream = new FlattenGraphFilter(new WordDelimiterGraphFilter(stream,
    ...
    // new FileReader(Paths.get(ppath.toString(), "src", "main", "java",
    // "similar_words.txt").toString()))) {
    ...
    // } catch (IOException e) {
    // System.out.println("IO ERROR: " + e.getLocalizedMessage() + " occurred when
    // trying to create synonym map");
    // } catch (Exception e) {
    // System.out.println("ERROR: " + e.getLocalizedMessage() + " occurred when
    // trying to create synonym map");
    // }
